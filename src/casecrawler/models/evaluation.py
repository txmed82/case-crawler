...
class CohortProfile(BaseModel):
    ...
    allergy_substance_counts: dict[str, int] = Field(default_factory=dict)
    allergy_reaction_counts: dict[str, int] = Field(default_factory=dict)
    allergy_severity_counts: dict[str, int] = Field(default_factory=dict)
    allergy_status_counts: dict[str, int] = Field(default_factory=dict)
    order_type_counts: dict[str, int] = Field(default_factory=dict)
    order_display_counts: dict[str, int] = Field(default_factory=dict)
    order_status_counts: dict[str, int] = Field(default_factory=dict)
    order_priority_counts: dict[str, int] = Field(default_factory=dict)
