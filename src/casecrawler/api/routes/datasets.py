...
def list_dataset_capabilities():
    ...
    return {
        ...
        "release_coverage_requirements": [
            {
                "key": key,
                "description": _release_coverage_requirement_description(key),
            }
...
def _release_coverage_requirement_description(key: str) -> str:
    descriptions = {
        "approved_records": "Every record is validation-approved or human-review approved.",
        "benchmark_reference": "At least one recommended benchmark reference dataset is resolved.",
        "discharge_summaries": "Clinical text includes physician discharge summaries.",
        "imaging_model_policy": "Generated image records include model license/use-policy metadata.",
        ...
        "task_reference_coverage": "Task-specific benchmark reference readiness is complete.",
